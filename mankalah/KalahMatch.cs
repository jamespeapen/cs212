...
namespace Mankalah
{
    ...
    public class KalahMatch {
        ...
        private static Player pTop = new vam6(Position.Top, timeLimit);	// TOP player (MAX)
        private static Player pBot = new Tux(Position.Bottom, timeLimit);	// BOTTOM player	
        ...
        */
        public static int playGame(Player pTop, Player pBot, Position firstPlayer)
        {
            ...
            while (!b.gameOver()) 
            {
	            ...
	            b.makeMove(move,false);		// last parameter says to be chatty
                b.display();
